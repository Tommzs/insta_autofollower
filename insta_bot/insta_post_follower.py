...
class InstaPostFollower:
    ...
    def follow(self):
        ...
        for post in self.post_list:
            ...
            time.sleep(3)
            driver.find_element_by_class_name(el.POST_FOLLOW_BUTTON_CLASS).click()
            time.sleep(10)
...
if __name__ == "__main__":
    ...
    login.login()
    follower = InstaPostFollower(ast.literal_eval(post_list_str), driver)
    follower.follow()